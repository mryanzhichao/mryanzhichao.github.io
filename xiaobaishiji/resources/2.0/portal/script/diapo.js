...
//you can also use more than one effect: 'curtainTopLeft, mosaic, bottomLeftTopRight'
	...
	if(isMobile()){
		...
		var section5 = document.createElement('div');
			...
			section5.innerHTML = '<div class="them2"> <div>合作伙伴<span style="color: #FECE00;">&nbsp;/&nbsp;</span><span style="color:#2e3192;">PARTNERS</span></div> </div>'
			+'<div class="brandItems2">'
			+'<ul class="ul2 clear">'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/logo-dx.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/shenzhenwangluoguangbo.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/xinjiangguangdian.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/shanghaidongfang.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/shenzhenguangdian.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/zhongguoguangdian.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/logo-yd.jpg"></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/stars-china.jpg"></li> '
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/PPTV.jpg" alt=""></li>'
			+'<li><img src="' + ADMS.ctx + '/resources/2.0/portal/img/centrin.png" alt=""></li></ul> </div>';

		var section6 =document.createElement('div');
		section6.id = 'section6';
		section6.className = 'section';
		section6.innerHTML = '<div class="bottom_index">'
			+'<div class="bottom clear">'
			+'<ul class="fl">'
			+'<li class="bottom_img"><img src="' + ADMS.ctx + '/resources/2.0/portal/img/footer01.png" alt=""></li>'
			+'<li class="bold"><a href="javascript:;">小白世纪</a></li>'
			+'<li><a href="http://www.xiaobaishiji.com/resources/2.0/portal/script/' + ADMS.ctx + '/contact">联系我们</a></li>'
			+'<li><a href="http://www.xiaobaishiji.com/resources/2.0/portal/script/' + ADMS.ctx + '/about">关于我们</a></li>'
			+'<li><a href="http://www.xiaobaishiji.com/resources/2.0/portal/script/' + ADMS.ctx + '/news">新闻动态</a></li></ul>'
			+'<ul class="fl">'
			+'<li class="bottom_img"> <img src="' + ADMS.ctx + '/resources/2.0/portal/img/footer02.png" alt=""></li>'
			+'<li class="bold"><a href="javascript:;">客户服务</a></li>'
			+'<li><a href="javascript:;">使用条款</a></li>'
			+'<li><a href="javascript:;">隐私政策</a></li>'
			+'<li><a href="javascript:;">帮助中心</a></li></ul>'
			+'<ul class="fl">'
			+'<li class="bottom_img"> <img src="' + ADMS.ctx + '/resources/2.0/portal/img/footer03.png" alt=""></li>'
			+'<li class="bold"><a href="javascript:;">商务合作</a></li>'
			+'<li><a href="javascript:;">渠道合作</a></li>'
			+'<li><a href="javascript:;">媒体合作</a></li></ul>'
			+'<ul class="fl">'
			+'<li class="bottom_img"><img src="' + ADMS.ctx + '/resources/2.0/portal/img/footer04.png" alt=""></li>'
			+'<li class="bold"><a href="javascript:;">关注我们</a></li>'
			+'<li><a href="javascript:;">新浪微博</a></li>'
			+'<li><a href="javascript:;">官方微信</a></li>'
			+'<li><a href="javascript:;">官方贴吧</a></li> </ul></div>'
			+'<div class="copyright">Copyright 2015 xiaobaishiji.com All Rights Reserved.  京ICP备11022410 </div></div>';

		parent.appendChild(section5)
		parent.appendChild(section6)
	}
	...
	if(elem.length!=0){
		...
		if(pagination==true) {
			...
			for (li = 0; li < amountSlide; li++){
				var m = selector.eq(li).attr('str')||li;
				$('#pix_pag_ul').append('<li id="pag_nav_'+li+'"><span><span><p style="">'+m+'</p></span></span></li>');
				if(opts.thumbs==true) {
			...
			$('#pix_pag_ul').append('<div class="hx"></div>');
		}
